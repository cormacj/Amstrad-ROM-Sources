...
C_C1F9:                               ; XREF: 0xC1B4 
    ...
    JP PREP_CPM_BOOT                  ;0xc1fc:   c3 69 c3  ".i." 
;--------------------------------------
C_C1FF:                               ; XREF: 0xC1F9 
    DI                                ;0xc1ff:   f3  "." 
...
RST18_data_c234:                      ; XREF: 
    ...
    LD HL,0xfec0                      ;0xc274:   21 c0 fe  "!.."  
    LD (0x2c3),HL                     ;0xc277:   22 c3 02  "".."  
    LD HL,0xfe80                      ;0xc27a:   21 80 fe  "!.."  
...
;--------------------------------------
CPMVER:                               ; XREF: 0xC00F 
    LD HL,COPYRIGHT_MESSAGE           ;0xc407:   21 4a c4  "!J."  
    CALL PRINT_STRING                 ;0xc40a:   cd ea c1  "..." 
    LD HL,ROM_MAJOR                   ;0xc40d:   21 01 c0  "!.."  
    CALL NUMBER_TO_ASCII              ;0xc410:   cd 43 c4  ".C." 
    LD A,0x2e                         ;0xc413:   3e 2e  ">."  
    CALL TXT_OUTPUT                   ;0xc415:   cd 5a bb  ".Z." 
    INC HL                            ;0xc418:   23  "#" 
    CALL NUMBER_TO_ASCII              ;0xc419:   cd 43 c4  ".C." 
    INC HL                            ;0xc41c:   23  "#" 
    CALL NUMBER_TO_ASCII              ;0xc41d:   cd 43 c4  ".C." 
;--------------------------------------
C_C420:                               ; XREF: 0xC3CE 
...
;--------------------------------------
C_C42B:                               ; XREF: 0xC3E6 
    CALL DECODE_OWNER_ADDRESS           ;0xc42b:   cd 3f c5  ".?." 
...
C_C434:                               ; XREF: 0xC3DF 
    ...
    CALL DECODE_OWNER_ADDRESS           ;0xc439:   cd 3f c5  ".?." 
    LD HL,STR_TWO_NEWLINES            ;0xc43c:   21 03 c5  "!.."  
    CALL PRINT_STRING                 ;0xc43f:   cd ea c1  "..." 
    RET                               ;0xc442:   c9  "." 
;--------------------------------------
NUMBER_TO_ASCII:                      ; XREF: 0xC410 
    LD A,(HL)                         ;0xc443:   7e  "~" 
    ADD A,0x30                        ;0xc444:   c6 30  ".0" 
    CALL TXT_OUTPUT                   ;0xc446:   cd 5a bb  ".Z." 
    RET                               ;0xc449:   c9  "." 
;--------------------------------------
COPYRIGHT_MESSAGE:                    ; XREF: 0xC407 
    DEFB 0xd                          ;0xc44a:   
    DEFB 0xa                          ;0xc44b:   0xa
...
;--------------------------------------
CPM_ROM_BY_GRADUATE_MSG:              ; XREF: 0xC44F 
    DEFB 0xa                          ;0xc4a1:   0xa
    DEFB 0xa                          ;0xc4a2:   0xa
...
;--------------------------------------
C_C509:                               ; XREF: 0xC4DA 
    JR nz,DECODE_OWNER                ;0xc509:   20 09  " ." 
    LD A,(IX+0)                       ;0xc50b:   dd 7e 00  ".~." 
;--------------------------------------
C_C50E:                               ; XREF: 0xC4AA 
    CP 2                              ;0xc50e:   fe 02  ".." 
    JR z,DECODE_SERIAL                ;0xc510:   28 1e  "(." 
    LD A,1                            ;0xc512:   3e 01  ">."  
;--------------------------------------
DECODE_OWNER:                         ; XREF: 0xC4D8 
    PUSH AF                           ;0xc514:   f5  "." 
    LD HL,ENCRYPTED_USER_NAME         ;0xc515:   21 00 ff  "!.."  
    LD B,0x18                         ;0xc518:   06 18  ".."  
    CALL DECODE_OWNER_ADDRESS           ;0xc51a:   cd 3f c5  ".?." 
;--------------------------------------
C_C51D:                               ; XREF: 0xC4FB 
    POP AF                            ;0xc51d:   f1  "." 
    CP 1                              ;0xc51e:   fe 01  ".." 
    RET nz                            ;0xc520:   c0  "." 
    LD HL,STR_SPACE_COLON_SPACE       ;0xc521:   21 49 c5  "!I."  
    CALL PRINT_STRING                 ;0xc524:   cd ea c1  "..." 
    LD HL,ENCRYPTED_SERIAL            ;0xc527:   21 71 ff  "!q."  
    LD B,0x12                         ;0xc52a:   06 12  ".."  
    CALL DECODE_OWNER_ADDRESS           ;0xc52c:   cd 3f c5  ".?." 
    RET                               ;0xc52f:   c9  "." 
;--------------------------------------
DECODE_SERIAL:                        ; XREF: 0xC510 
...
;--------------------------------------
DECODE_OWNER_ADDRESS:                 ; XREF: 0xC42B 
    LD A,(HL)                         ;0xc53f:   7e  "~" 
...
;--------------------------------------
C_C546:                               ; XREF: 0xC4CE 
    DJNZ DECODE_OWNER_ADDRESS           ;0xc546:   10 f7  ".." 
    RET                               ;0xc548:   c9  "." 
;--------------------------------------
STR_SPACE_COLON_SPACE:                ; XREF: 0xC521 
    DEFB 0x20                         ;0xc549:   " "
    DEFB 0x3a                         ;0xc54a:   ":"
    DEFB 0x20                         ;0xc54b:   " "
...
NO_SECOND_ROM:                        ; XREF: 0xC569 
    ...
    RET                               ;0xc5a3:   c9  "." 
;--------------------------------------
NO_DISC_ROM:                          ; XREF: 0xC5E6 
    CALL LOOKUP_DISC_ROM              ;0xc5a4:   cd b1 c5  "..." 
...
C_C6CD:                               ; XREF: 0xC69D 
    ...
    RET                               ;0xc6ce:   c9  "." 
;--------------------------------------
CPM_MENU_HEADER:                      ; XREF: 0xC7F0 0xC99A 
    DEFB 0x18                         ;0xc6cf:   0x18
    DEFB " C P ", 0x43                ;0xc6d0:   0xc6d0 to 0xc6d1
    DEFB 0x20                         ;0xc6d6:   
    DEFB 0x20                         ;0xc6d7:   
;--------------------------------------
S_C6D8:                               ; XREF: 0xC6B5 
...
PRESS_ESC_MSG:                        ; XREF: 0xC9A0 
    ...
    RET                               ;0xc7c0:   c9  "." 
;--------------------------------------
RELO_AREA_TODO:                       ; XREF: 0xC806 
    PUSH HL                           ;0xc7c1:   e5  "." 
    LD HL,(0x6f00)                    ;0xc7c2:   2a 00 6f  "*.o"  
    LD (HL),A                         ;0xc7c5:   77  "w" 
    INC HL                            ;0xc7c6:   23  "#" 
...
;--------------------------------------
C_C7F0:                               ; XREF: 0xC7DA 
    LD HL,CPM_MENU_HEADER             ;0xc7f0:   21 cf c6  "!.."  
...
RST18_data_c824:                      ; XREF: 0xC7AE 
    ...
    RST 0x18                          ;0xc851:   df  "." 
;--------------------------------------
RST18_data_c852:                      ; XREF: 
    DEFB 0x6f10                       ;0xc852:   
    CALL LOOKUP_DISC_ROM              ;0xc854:   cd b1 c5  "..." 
    POP HL                            ;0xc857:   e1  "." 
...
C_C97F:                               ; XREF: 0xC97B 
    ...
    JP PREP_CPM_BOOT                  ;0xc98f:   c3 69 c3  ".i." 
;--------------------------------------
C_C992:                               ; XREF: 0xC8E2 
    CALL TXT_INITIALIZE               ;0xc992:   cd 4e bb  ".N." 
    LD A,2                            ;0xc995:   3e 02  ">."  
    CALL SCR_SET_MODE                 ;0xc997:   cd 0e bc  "..." 
    LD HL,CPM_MENU_HEADER             ;0xc99a:   21 cf c6  "!.."  
...
PW_INPUT_LOOP:                        ; XREF: 0xCA05 
    ...
    INC HL                            ;0xca0a:   23  "#" 
    INC B                             ;0xca0b:   04  "." 
    CALL PW_DELETE_CHAR_ON_SCREEN           ;0xca0c:   cd 23 ca  ".#." 
    JP PW_INPUT_LOOP                  ;0xca0f:   c3 ec c9  "..." 
;--------------------------------------
...
;--------------------------------------
PW_MOVE_BUFFER_BACK_ONE:              ; XREF: 0xCA18 
    DEC B                             ;0xca1e:   05  "." 
    DEC HL                            ;0xca1f:   2b  "+" 
    JP PW_DELETE_CHAR_ON_SCREEN           ;0xca20:   c3 23 ca  ".#." 
;--------------------------------------
PW_DELETE_CHAR_ON_SCREEN:             ; XREF: 0xCA0C 
...
C_CB27:                               ; XREF: 0xCB32 
    NOP                               ;0xcb27:   00  "." 
    CALL IY_ADDR_JUMP                 ;0xcb28:   cd 1a cc  "..." 
...
C_CBC2:                               ; XREF: 0xCBF5 
    ...
    ADD HL,DE                         ;0xcbda:   19  "." 
    CALL IY_ADDR_JUMP                 ;0xcbdb:   cd 1a cc  "..." 
    ...
    ADD HL,DE                         ;0xcbe9:   19  "." 
    CALL IY_ADDR_JUMP                 ;0xcbea:   cd 1a cc  "..." 
    CP 0xff                           ;0xcbed:   fe ff  ".." 
    RET z                             ;0xcbef:   c8  "." 
    PUSH HL                           ;0xcbf0:   e5  "." 
    CALL PRINT_NEWLINE                ;0xcbf1:   cd f7 cb  "..." 
    POP HL                            ;0xcbf4:   e1  "." 
...
C_CC00:                               ; XREF: 0xCC09 
    PUSH BC                           ;0xcc00:   c5  "." 
    CALL IY_ADDR_JUMP                 ;0xcc01:   cd 1a cc  "..." 
    POP BC                            ;0xcc04:   c1  "." 
    ...
    RET                               ;0xcc0b:   c9  "." 
;--------------------------------------
STR_SEVERAL_SPACES:                   ; XREF: 0xCBD0 
    DEFB 0x20                         ;0xcc0c:   
    DEFB "         ", 0x20            ;0xcc0d:   0xcc0d to 0xcc0e
;--------------------------------------
STR_NEWLINE:                          ; XREF: 0xCBF7 
    DEFB 0xd                          ;0xcc17:   0xd
    DEFB 0xa                          ;0xcc18:   0xa
    DEFB 0x24                         ;0xcc19:   "$"
;--------------------------------------
IY_ADDR_JUMP:                         ; XREF: 0xCB02 
    JP (IY)                           ;0xcc1a:   fd e9  ".." 
;--------------------------------------
D_CC1C:                               ; XREF: 0xCAE4 
    PUSH BC                           ;0xcc1c:   c5  "." 
...
C_CCCC:                               ; XREF: 0xF5E5 
    ...
    JP PREP_CPM_BOOT                  ;0xcceb:   c3 69 c3  ".i." 
;--------------------------------------
D_CCEE:                               ; XREF: 0xC250 
...
C_cfaf:                               ; XREF: 
    PUSH DE                           ;0xcfaf:   d5  "." 
    LD HL,(0x1)                       ;0xcfb0:   2a 01 00  "*.."  
    LD DE,0x57                        ;0xcfb3:   11 57 00  ".W."  
    ADD HL,DE                         ;0xcfb6:   19  "." 
    LD (0x124f),HL                    ;0xcfb7:   22 4f 12  ""O."  
    POP DE                            ;0xcfba:   d1  "." 
    POP HL                            ;0xcfbb:   e1  "." 
    CALL 0x0                          ;0xcfbc:   cd 00 00  "..." 
    NOP                               ;0xcfbf:   00  "." 
    NOP                               ;0xcfc0:   00  "." 
    RET                               ;0xcfc1:   c9  "." 
...
;--------------------------------------
C_d02a:                               ; XREF: 
    LD BC,0x1100                      ;0xd02a:   01 00 11  "..."  
    LD D,A                            ;0xd02d:   57  "W" 
    NOP                               ;0xd02e:   00  "." 
    ADD HL,DE                         ;0xd02f:   19  "." 
    LD (0x12c6),HL                    ;0xd030:   22 c6 12  "".."  
    CALL 0x0                          ;0xd033:   cd 00 00  "..." 
    LD DE,D_D9BC                      ;0xd036:   11 bc d9  "..."  
    LD C,0x8c                         ;0xd039:   0e 8c  ".."  
    OR C                              ;0xd03b:   b1  "." 
    LD C,A                            ;0xd03c:   4f  "O" 
    OUT (C),C                         ;0xd03d:   ed 49  ".I" 
    EXX                               ;0xd03f:   d9  "." 
    RET                               ;0xd040:   c9  "." 
    LD A,8                            ;0xd041:   3e 08  ">."  
    LD (0xc86),A                      ;0xd043:   32 86 0c  "2.."  
    LD DE,0x12e3                      ;0xd046:   11 e3 12  "..."  
    LD A,0x32                         ;0xd049:   3e 32  ">2"  
    LD (0x12a8),A                     ;0xd04b:   32 a8 12  "2.."  
    JP 0x1294                         ;0xd04e:   c3 94 12  "..." 
;--------------------------------------
S_d051:                               ; XREF: 0xD022 
    DEFB "Language No.(0-7) :$"       ;0xd051:   0xd051 to 0xd065
;--------------------------------------
C_d065:                               ; XREF: 
    LD DE,0x12fd                      ;0xd065:   11 fd 12  "..."  
    JP 0x1275                         ;0xd068:   c3 75 12  ".u." 
    DEC DE                            ;0xd06b:   1b  "." 
    LD C,B                            ;0xd06c:   48  "H" 
;--------------------------------------
C_D06D:                               ; XREF: 0xD01D 
...
C_d0ea:                               ; XREF: 
    ...
    NOP                               ;0xd0f0:   00  "." 
    INC H                             ;0xd0f1:   24  "$" 
    LD HL,SCR_SET_INK                 ;0xd0f2:   21 32 bc  "!2."  
    LD (0x1251),HL                    ;0xd0f5:   22 51 12  ""Q."  
    LD A,0x10                         ;0xd0f8:   3e 10  ">."  
    LD (0xc86),A                      ;0xd0fa:   32 86 0c  "2.."  
...
C_d13f:                               ; XREF: 
    CP E                              ;0xd13f:   bb  "." 
    LD (0x1251),HL                    ;0xd140:   22 51 12  ""Q."  
    LD A,0x10                         ;0xd143:   3e 10  ">."  
    LD (0xc86),A                      ;0xd145:   32 86 0c  "2.."  
...
C_d167:                               ; XREF: 
    CP E                              ;0xd167:   bb  "." 
    LD (0x1251),HL                    ;0xd168:   22 51 12  ""Q."  
    LD A,0x10                         ;0xd16b:   3e 10  ">."  
    LD (0xc86),A                      ;0xd16d:   32 86 0c  "2.."  
...
C_E057:                               ; XREF: 0xE035 
    ...
    LD (HL),A                         ;0xe107:   77  "w" 
    LDIR                              ;0xe108:   ed b0  ".." 
    LD HL,C_fe58                      ;0xe10a:   21 58 fe  "!X."  
    LD DE,0xfe59                      ;0xe10d:   11 59 fe  ".Y."  
...
;--------------------------------------
C_F22E:                               ; XREF: 0xF1DA 
    LD (0xfe59),BC                    ;0xf22e:   ed 43 59 fe  ".CY."  
...
C_F235:                               ; XREF: 0xF1BF 
    ...
    NOP                               ;0xf24f:   00  "." 
    LD C,A                            ;0xf250:   4f  "O" 
    LD (0xfe59),BC                    ;0xf251:   ed 43 59 fe  ".CY."  
...
C_FB31:                               ; XREF: 0xFB0F 
    EX AF,AF'                         ;0xfb31:   08  "." 
    EXX                               ;0xfb32:   d9  "." 
    LD (0xfee1),BC                    ;0xfb33:   ed 43 e1 fe  ".C.."  
    POP HL                            ;0xfb37:   e1  "." 
    POP DE                            ;0xfb38:   d1  "." 
    POP BC                            ;0xfb39:   c1  "." 
;--------------------------------------
C_FB3A:                               ; XREF: 0xFB18 
    ...
    EXX                               ;0xfb3c:   d9  "." 
    POP AF                            ;0xfb3d:   f1  "." 
    LD SP,(0xfedb)                    ;0xfb3e:   ed 7b db fe  ".{.."  
    EI                                ;0xfb42:   fb  "." 
;--------------------------------------
C_FB43:                               ; XREF: 0xFB21 
    RET                               ;0xfb43:   c9  "." 
    ...
    EXX                               ;0xfb4b:   d9  "." 
    LD HL,(C_FEDF)                    ;0xfb4c:   2a df fe  "*.."  
    CALL C_fdad                       ;0xfb4f:   cd ad fd  "..." 
    LD A,(C_fe58)                     ;0xfb52:   3a 58 fe  ":X."  
...
C_FB86:                               ; XREF: 0xFB7C 
    ...
    RET z                             ;0xfb89:   c8  "." 
    DEC A                             ;0xfb8a:   3d  "=" 
    LD HL,(C_FBC2)                    ;0xfb8b:   2a c2 fb  "*.."  
    JR C_FB9E                         ;0xfb8e:   18 0e  ".." 
    LD HL,(C_fbbe)                    ;0xfb90:   2a be fb  "*.."  
    LD A,H                            ;0xfb93:   7c  "|" 
...
C_FB9E:                               ; XREF: 0xFB8E 
    ...
    LD (0xfe59),A                     ;0xfbae:   32 59 fe  "2Y."  
    XOR A                             ;0xfbb1:   af  "." 
    PUSH BC                           ;0xfbb2:   c5  "." 
    LD (C_fe58),A                     ;0xfbb3:   32 58 fe  "2X."  
    ...
    RET                               ;0xfbbd:   c9  "." 
;--------------------------------------
C_fbbe:                               ; XREF: 0xFB90 0xFBA8 
    LD (C_FEDD),HL                    ;0xfbbe:   22 dd fe  "".."  
    POP HL                            ;0xfbc1:   e1  "." 
;--------------------------------------
C_FBC2:                               ; XREF: 0xFB8B 
    PUSH HL                           ;0xfbc2:   e5  "." 
    INC HL                            ;0xfbc3:   23  "#" 
;--------------------------------------
C_FBC4:                               ; XREF: 0xFB79 0xFB67 
    INC HL                            ;0xfbc4:   23  "#" 
    EX (SP),HL                        ;0xfbc5:   e3  "." 
;--------------------------------------
C_FBC6:                               ; XREF: 0xFB6C 0xFB7E 
    PUSH HL                           ;0xfbc6:   e5  "." 
    LD HL,(C_FEDD)                    ;0xfbc7:   2a dd fe  "*.."  
    DI                                ;0xfbca:   f3  "." 
    EX AF,AF'                         ;0xfbcb:   08  "." 
    EXX                               ;0xfbcc:   d9  "." 
    EX (SP),HL                        ;0xfbcd:   e3  "." 
    LD (0xfedb),SP                    ;0xfbce:   ed 73 db fe  ".s.."  
    LD SP,D_FF53                      ;0xfbd2:   31 53 ff  "1S."  
    PUSH DE                           ;0xfbd5:   d5  "." 
    PUSH BC                           ;0xfbd6:   c5  "." 
    PUSH AF                           ;0xfbd7:   f5  "." 
    LD E,(HL)                         ;0xfbd8:   5e  "^" 
    INC HL                            ;0xfbd9:   23  "#" 
    LD D,(HL)                         ;0xfbda:   56  "V" 
    LD A,(C_fe58)                     ;0xfbdb:   3a 58 fe  ":X."  
    PUSH AF                           ;0xfbde:   f5  "." 
;--------------------------------------
C_FBDF:                               ; XREF: 0xE4D9 
    CALL 0xfd03                       ;0xfbdf:   cd 03 fd  "..." 
    LD A,0xe6                         ;0xfbe2:   3e e6  ">."  
    LD (D_FDAF),A                     ;0xfbe4:   32 af fd  "2.."  
    LD BC,(0xfee1)                    ;0xfbe7:   ed 4b e1 fe  ".K.."  
    OR A                              ;0xfbeb:   b7  "." 
    CALL 0xfd5d                       ;0xfbec:   cd 5d fd  ".]." 
    DI                                ;0xfbef:   f3  "." 
    EX AF,AF'                         ;0xfbf0:   08  "." 
    EXX                               ;0xfbf1:   d9  "." 
    LD (0xfee1),BC                    ;0xfbf2:   ed 43 e1 fe  ".C.."  
    LD A,0xb2                         ;0xfbf6:   3e b2  ">."  
    LD (D_FDAF),A                     ;0xfbf8:   32 af fd  "2.."  
    POP AF                            ;0xfbfb:   f1  "." 
    CALL 0xfd04                       ;0xfbfc:   cd 04 fd  "..." 
    POP AF                            ;0xfbff:   f1  "." 
;--------------------------------------
C_FC00:                               ; XREF: 0xF53C 0xF4BE 
    POP BC                            ;0xfc00:   c1  "." 
    POP DE                            ;0xfc01:   d1  "." 
    LD SP,(0xfedb)                    ;0xfc02:   ed 7b db fe  ".{.."  
;--------------------------------------
C_FC06:                               ; XREF: 0xFD77 
    POP HL                            ;0xfc06:   e1  "." 
    EX AF,AF'                         ;0xfc07:   08  "." 
...
C_FC0F:                               ; XREF: 0xFD39 
    RET                               ;0xfc0f:   c9  "." 
    LD (0xfedb),SP                    ;0xfc10:   ed 73 db fe  ".s.."  
...
C_fc18:                               ; XREF: 0xE6F7 
    ...
    PUSH DE                           ;0xfc1c:   d5  "." 
    PUSH HL                           ;0xfc1d:   e5  "." 
    LD BC,(0xfee1)                    ;0xfc1e:   ed 4b e1 fe  ".K.."  
    OR A                              ;0xfc22:   b7  "." 
    EXX                               ;0xfc23:   d9  "." 
    EX AF,AF'                         ;0xfc24:   08  "." 
    LD A,0xe6                         ;0xfc25:   3e e6  ">."  
    LD (D_FDAF),A                     ;0xfc27:   32 af fd  "2.."  
    RST 0x38                          ;0xfc2a:   ff  "." 
    DI                                ;0xfc2b:   f3  "." 
    LD A,0xb2                         ;0xfc2c:   3e b2  ">."  
    CALL 0xfd04                       ;0xfc2e:   cd 04 fd  "..." 
    LD A,0xc3                         ;0xfc31:   3e c3  ">."  
    LD HL,C_FDAE                      ;0xfc33:   21 ae fd  "!.."  
    LD (0x138),A                      ;0xfc36:   32 38 01  "28."  
    NOP                               ;0xfc39:   00  "." 
    LD (0x139),HL                     ;0xfc3a:   22 39 01  ""9."  
    NOP                               ;0xfc3d:   00  "." 
    LD HL,0xfc03                      ;0xfc3e:   21 03 fc  "!.."  
    LD (0x2),A                        ;0xfc41:   32 02 00  "2.."  
    LD (0x101),HL                     ;0xfc44:   22 01 01  "".."  
    NOP                               ;0xfc47:   00  "." 
    LD HL,(0xfbfe)                    ;0xfc48:   2a fe fb  "*.."  
;--------------------------------------
C_FC4B:                               ; XREF: 0xFEB6 
    ...
    LD A,(BC)                         ;0xfc6b:   0a  "." 
    LD (0xfe59),BC                    ;0xfc6c:   ed 43 59 fe  ".CY."  
    RET                               ;0xfc70:   c9  "." 
;--------------------------------------
C_FC71:                               ; XREF: 0xFC7A 
    EX DE,HL                          ;0xfc71:   eb  "." 
...
C_FC92:                               ; XREF: 0xFC8C 
    EX (SP),HL                        ;0xfc92:   e3  "." 
    LD A,(0xfe59)                     ;0xfc93:   3a 59 fe  ":Y."  
    CALL 0xfd04                       ;0xfc96:   cd 04 fd  "..." 
    PUSH DE                           ;0xfc99:   d5  "." 
    PUSH BC                           ;0xfc9a:   c5  "." 
    LD DE,C_FE5B                      ;0xfc9b:   11 5b fe  ".[."  
    LDIR                              ;0xfc9e:   ed b0  ".." 
    POP BC                            ;0xfca0:   c1  "." 
    POP DE                            ;0xfca1:   d1  "." 
    LD A,(0xfe5a)                     ;0xfca2:   3a 5a fe  ":Z."  
    CALL 0xfd04                       ;0xfca5:   cd 04 fd  "..." 
    PUSH HL                           ;0xfca8:   e5  "." 
    LD HL,C_FE5B                      ;0xfca9:   21 5b fe  "![."  
    LDIR                              ;0xfcac:   ed b0  ".." 
    POP HL                            ;0xfcae:   e1  "." 
    POP BC                            ;0xfcaf:   c1  "." 
    LD A,B                            ;0xfcb0:   78  "x" 
...
C_FCC0:                               ; XREF: 0xFD02 
    ...
    EXX                               ;0xfd1a:   d9  "." 
    LD (0xfee1),BC                    ;0xfd1b:   ed 43 e1 fe  ".C.."  
    EXX                               ;0xfd1f:   d9  "." 
    LD HL,(0x139)                     ;0xfd20:   2a 39 01  "*9."  
    NOP                               ;0xfd23:   00  "." 
    LD (C_FEDF),HL                    ;0xfd24:   22 df fe  "".."  
    LD HL,C_FDAE                      ;0xfd27:   21 ae fd  "!.."  
...
C_fdad:                               ; XREF: 0xFB4F 
    POP HL                            ;0xfdad:   e1  "." 
;--------------------------------------
C_FDAE:                               ; XREF: 0xFC33 0xFD27 
    DEC HL                            ;0xfdae:   2b  "+" 
;--------------------------------------
D_FDAF:                               ; XREF: 0xFBE4 0xFC27 0xFB2E 0xFD30 0xFBF8 
    LD (0xfbe1),HL                    ;0xfdaf:   22 e1 fb  "".."  
    POP BC                            ;0xfdb2:   c1  "." 
    LD A,L                            ;0xfdb3:   7d  "}" 
    AND 3                             ;0xfdb4:   e6 03  ".." 
    CP 3                              ;0xfdb6:   fe 03  ".." 
...
C_FE5B:                               ; XREF: 0xFCA9 0xFC9B 
    ...
    LD HL,D_FA2E                      ;0xfeac:   21 2e fa  "!.."  
    LD (D_FA2A),HL                    ;0xfeaf:   22 2a fa  ""*."  
    LD BC,0x180                       ;0xfeb2:   01 80 01  "..."  
    NOP                               ;0xfeb5:   00  "." 
    CALL C_FC4B                       ;0xfeb6:   cd 4b fc  ".K." 
    LD (HL),1                         ;0xfeb9:   36 01  "6."  
    NOP                               ;0xfebb:   00  "." 
    LD C,0x98                         ;0xfebc:   0e 98  ".."  
    LD DE,D_FA2A                      ;0xfebe:   11 2a fa  ".*."  
    CALL C_F8D5                       ;0xfec1:   cd d5 f8  "..." 
    POP BC                            ;0xfec4:   c1  "." 
    LD A,L                            ;0xfec5:   7d  "}" 
    OR H                              ;0xfec6:   b4  "." 
    ...
    LD H,A                            ;0xfed8:   67  "g" 
    ADD HL,BC                         ;0xfed9:   09  "." 
    LD (D_FA28),HL                    ;0xfeda:   22 28 fa  ""(."  
;--------------------------------------
C_FEDD:                               ; XREF: 0xFBBE 0xFBC7 
    POP HL                            ;0xfedd:   e1  "." 
    POP DE                            ;0xfede:   d1  "." 
;--------------------------------------
C_FEDF:                               ; XREF: 0xFB4C 0xFD24 
    LD BC,0x124                       ;0xfedf:   01 24 01  ".$."  
    NOP                               ;0xfee2:   00  "." 
